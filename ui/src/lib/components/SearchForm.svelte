      ...
      <div class="flex flex-row gap-3">
        <div>
          <input
            ...
            class="border-b-1 border-white font-mono focus:ring-0 focus:ring-offset-0 focus:outline-none"
        ...
        <div>
          ...
          >
            {#if loading || isNavigating}
              <span class="opacity-50"> Searching... </span>
            {:else}
              <span class="underline {query.trim() ? '' : 'opacity-50'}"> Go </span>
            {/if}
          </button>
        </div>
      </div>
