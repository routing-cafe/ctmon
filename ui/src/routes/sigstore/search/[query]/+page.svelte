						...
						<table class="text-xs leading-tight font-mono">
							<thead>
								...
								>
									...
									{/if}
									<th
										class="text-right py-1 font-medium w-32"
										style="color: var(--muted-foreground);"
									>
										Entry UUID
									</th>
							...
							<tbody>
								{#each entries as entry, index}
									...
									>
										...
										{/if}
										<td class="py-0.5 pr-4 max-w-xs truncate">
										...
										{/if}
										<td class="py-0.5 text-right w-32">
											<a
												href="/sigstore/entry/{entry.entry_uuid}"
												class="transition-colors duration-150 ease-out underline hover:opacity-75"
